...
export default function MoistureControlTab() {
  ...
  return (
    <div className="max-w-2xl mx-auto p-4 space-y-6">
      <h2 className="text-lg font-semibold text-gray-800">{t('mc.title')}</h2>

      {/* Fan section */}
      <div>
        <h3 className="text-sm font-semibold text-gray-700 mb-2">{t('mc.fanSection')}</h3>
      ...
      {/* Heat Exchanger */}
      <div>
        <h3 className="text-sm font-semibold text-gray-700 mb-2">{t('mc.heatExchanger')}</h3>
      ...
      {/* Crop Conditions */}
      <div>
        <h3 className="text-sm font-semibold text-gray-700 mb-2">{t('mc.cropConditions')}</h3>
        <div className="space-y-2 bg-gray-50 rounded-lg p-4">
      ...
      {/* Moisture Transport */}
      <div>
        <h3 className="text-sm font-semibold text-gray-700 mb-2">{t('mc.moistureTransport')}</h3>
        <div className="space-y-2 bg-gray-50 rounded-lg p-4">
        ...
        <div className="mt-3 border border-gray-200 rounded-lg divide-y divide-gray-200">
          ...
          <div className="flex justify-between p-3 text-sm bg-green-50">
            <span className="text-green-800 font-medium">{t('mc.totalTransport')}</span>
            <span className="font-mono font-medium text-green-700">{fmt2(result.totalMoistureTransport)} g/m²·hr</span>
          </div>
        </div>
      </div>
    </div>
